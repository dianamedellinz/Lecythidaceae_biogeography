...
setwd("/Users/dianamedellin/Documents/Lecythidaceae/Biogeography/Biogeo_analyses_2025/DEC")
...
#-------------------
resfn = "Lecythidoideae_DEC.Rdata" # Name file in which to save the run
...
pdffn = "Lecythidaceae_DEC_reconstruction.pdf"
pdf(pdffn, width=18, height=31)

# Plot ancestral states - DEC
analysis_titletxt ="BioGeoBEARS DEC on Lecythidaceae"
...
# States
plot_BioGeoBEARS_results(results_object, colors_list_for_states = my_colors_list, analysis_titletxt, plotwhat="text", label.offset=1.2, tipcex=1.1, statecex=0.8, splitcex=0.8, titlecex=0.8, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, colors_list_for_states = my_colors_list, analysis_titletxt, plotwhat="pie", label.offset=1.2, tipcex=1.1, statecex=0.5, splitcex=0.8, titlecex=0.8, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
