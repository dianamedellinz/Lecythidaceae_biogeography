...
setwd("/Users/dianamedellin/Documents/Lecythidaceae/Biogeography/Biogeo_analyses_2025/DIVALIKE")
...
#-------------------
resfn = "lecy_DIVALIKE_2025.Rdata" # Name file in which to save the run
...
pdffn = "Lecythidaceae_DIVALIKE_2025.pdf"
pdf(pdffn, width=18, height=42)

# Plot ancestral states - DEC
analysis_titletxt ="BioGeoBEARS DIVALIKE on Lecythidaceae"
