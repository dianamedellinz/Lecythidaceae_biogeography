...
setwd("/Users/dianamedellin/Documents/Lecythidaceae/Biogeography/Biogeo_analyses_2025/Northern_Andes/Grias_Gustavia_DIVALIKE")
...
#-------------------
# Check the maximum range size in my geog_data
max(rowSums(dfnums_to_numeric(tipranges@df)))
#4

# Set the maximum range size based on your geog_data
max_range_size = 4
# A value of 4 means that even though none of my modern taxa occur in more than one area,
# ancestral lineages can occupy up to four areas. That allows the model to find
# widespread ranges in the past, which can then be used to find evidence for vicariance 
...
#######################################################
# The BioGeoBEARS "DIVALIKE" model is not identical with 
...
#######################################################
# Run DIVALIKE (preparing objects for DIVALIKE run)
######################################################
...
#-------------------
resfn = "Grias_Gustavia_DIVALIKE.Rdata" # Name file in which to save the run
...
mypalette <- c("red", "blue", "orange", "darkturquoise", "yellow", "green", "#FF00FF")
...
pdffn = "Grias_Gustavia_DIVALIKE_reconstruction.pdf"
pdf(pdffn, width=19, height=16)

# Plot ancestral states - DIVALIKE
analysis_titletxt ="BioGeoBEARS DIVALIKE on Grias+Gustavia"
