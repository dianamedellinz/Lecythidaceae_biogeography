...
setwd("/Users/dianamedellin/Documents/Lecythidaceae/Biogeography/Biogeo_analyses_2025/Northern_Andes/Grias_Gustavia_BAYAREALIKE")
...
#-------------------
resfn = "Grias_Gustavia_BAYAREALIKE.Rdata" # Name file in which to save the run
...
pdffn = "Grias_Gustavia_BAYAREALIKE_reconstruction.pdf"
pdf(pdffn, width=19, height=20)

# Plot ancestral states - BAYAREALIKE
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Grias+Gustavia"
