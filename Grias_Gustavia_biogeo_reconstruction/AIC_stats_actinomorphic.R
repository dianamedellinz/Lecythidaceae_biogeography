...
setwd("/Users/dianamedellin/Documents/Lecythidaceae/Biogeography/Biogeo_analyses_2025/Northern_Andes")
...
write.csv(final, file = "AIC_actinomorphic.csv")
write.table(final, file = "AIC_actinomorphic.txt", quote = F, sep = "\t")
